<template>
  <div class="space-y-8 animate-fade-in select-none w-full">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <BaseCard v-for="(stat, idx) in stats" :key="idx" density="compact"
        ...
        <div>
          <p class="text-[11px] font-bold text-base-content/40 uppercase tracking-wider">
            {{ stat.label }}
          </p>
        ...
        <div class="absolute right-4 bottom-4 text-base-content/10 text-3xl pointer-events-none">
    ...
    <div class="space-y-4">
      <div class="flex justify-between items-center px-1">
        ...
        <RouterLink to="/candidat/applications"
      ...
      <div class="space-y-3">
        <BaseCard v-for="app in applications" :key="app.id" density="compact" hoverable
          class="bg-white border border-base-200 rounded-2xl p-4 transition-all hover:border-base-300">
          <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4 text-left">
            <div class="flex items-center gap-4 min-w-0">
              ...
              <div class="min-w-0">
                <h3 class="font-black text-base-content tracking-tight truncate">
                  {{ app.role }}
                </h3>
            ...
            <div class="flex items-center justify-between sm:justify-end gap-4 shrink-0">
              ...
              <span class="text-[10px] uppercase font-black tracking-wider px-2.5 py-1 rounded-md border"
...
//@ts-check
const { currentUser: { value: { name } } } = useAuth();


const stats = [
  { label: "Candidatures envoyées", value: 12, icon: "candidat" },
  { label: "En attente", value: 8, icon: "cloche" },
  { label: "Acceptées", value: 2, icon: "validation" },
  { label: "Refusées", value: 2, icon: "lock" },
];
