<template>
  <div class="w-full text-left select-none" data-aos="fade-up">
    ...
    <div v-if="filteredCandidates.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <BaseCard v-for="candidate in filteredCandidates" :key="candidate.id"
        ...
        <div>
          ...
          <div class="flex items-start justify-between gap-4 mb-4">
            ...
            <div class="text-right">
              <span class="text-[11px] font-black uppercase tracking-wider px-3 py-1 rounded-lg border inline-block"
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2 mb-4 pt-3 border-t border-base-100 items-center">
            ...
            <span v-if="candidate.skills.length > 4" class="text-xs text-base-content/50">+{{ candidate.skills.length -
              4 }}
              autres</span>
          </div>
          ...
          <div class="flex gap-2 w-full mt-2">
            ...
            <BaseButton @click="toggleBookmark(candidate.id)" variant="ghost" class="w-12 h-9 rounded-xl">
