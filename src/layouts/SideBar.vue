<template>
  ...
  -->
  <div
    class="drawer lg:drawer-open bg-base-200/30 min-h-screen font-sans selection:bg-accent selection:text-white"
  >
    ...
    <div class="drawer-content flex flex-col h-screen overflow-hidden">
      ...
      >
        ...
        <div class="flex-1">
          <h1
            class="text-lg lg:text-xl font-black text-base-content tracking-tight"
          >
            Vue d'ensemble
          </h1>
        </div>
        ...
        <div class="flex-none flex items-center gap-2 lg:gap-4">
          ...
          <div class="hidden md:block relative group">
            ...
            <div class="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
              <kbd
                class="kbd kbd-sm text-[10px] bg-base-100 border-base-200 shadow-none text-base-content/50"
                >⌘</kbd
              >
              <kbd
                class="kbd kbd-sm text-[10px] bg-base-100 border-base-200 shadow-none text-base-content/50"
          ...
          <!-- Divider Horizontal -->
          <div
            class="divider divider-horizontal mx-0 hidden lg:flex before:bg-base-200 after:bg-base-200"
          ></div>
          ...
          <div class="dropdown dropdown-end ml-1" v-if="user">
            ...
            >
              <div
                class="w-8 h-8 rounded-full bg-base-200 flex items-center justify-center overflow-hidden"
              >
                <!-- Affiche l'avatar s'il existe, sinon fallback initials -->
                <img
                  v-if="user.avatar"
                  :src="user.avatar"
                  alt="Avatar Recruteur"
            ...
            >
              ...
              <li>
                <router-link
                  ...
                  class="py-2.5 font-medium hover:text-accent"
                >
                  <BaseIcon
                    name="profil"
                    class="w-4 text-center mr-2 text-base-content/40"
                  />
                  Mon Profil
                </router-link>
              </li>
              ...
              <li>
                <button
                  @click="handleLogout"
                  class="py-2.5 font-bold text-error hover:bg-error/10 hover:text-error"
                >
      ...
      <main
        class="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 custom-scrollbar relative max-w-[1600px] w-full mx-auto"
      >
        <slot />
      </main>
    </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-2">
            ...
            >
            <span
              class="badge badge-sm bg-accent/10 text-accent font-black border-none text-[9px] tracking-wider uppercase ml-1"
              >Recruiter</span
            >
          </div>
        ...
        <div
          class="flex-1 overflow-y-auto py-4 px-3 custom-scrollbar space-y-6"
        >
          <!-- SECTION 1 : Recrutement -->
          <div>
            <h3
              class="px-3 text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-2"
            >
              Recrutement
            </h3>
            <ul class="menu px-1 gap-0.5 text-sm font-semibold">
              <li
                v-for="(item, index) in recruitmentMenu"
                :key="'rec-' + index"
              >
                <router-link
                  :to="item.to"
                ...
                >
                  ...
                  <span
                    v-if="item.badge"
                    class="badge badge-sm border-none font-bold text-[10px] ml-auto"
                    :class="
                      item.badgeColor || 'bg-base-200 text-base-content/70'
                    "
                  >
                    {{ item.badge }}
                  </span>
          ...
          <div>
            ...
            <ul class="menu px-1 gap-0.5 text-sm font-semibold">
              <li
                v-for="(item, index) in communicationMenu"
                :key="'com-' + index"
              >
                <router-link
                  :to="item.to"
              ...
              <div class="min-w-0 flex-1">
                <div class="flex items-center gap-1.5">
                  ...
                  <BaseIcon
                    ...
                    title="Compte Entreprise vérifié"
                  />
                </div>
                <p
                  class="text-[11px] font-semibold text-base-content/50 truncate mb-0.5"
                >
                  {{ company.sector }}
                </p>
                <span
